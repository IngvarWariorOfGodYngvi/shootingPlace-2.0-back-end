...
public class PersonalCardPdfGenerator {
    ...
    public PersonalCardPdfGenerator(
    ...
    public PdfGenerationResults generate(MemberEntity member)
        ...
        String fileName = "Karta Członkowska "
                + member.getFirstName().stripTrailing() + " "
                + member.getSecondName().stripTrailing() + ".pdf";
        ...
        writer.setPageEvent(new PageStamper(environment, false, true));
        ...
        if (profile.equals(ProfilesEnum.DZIESIATKA.getName())
        ...
        String statement =
                "Oświadczenie:\n" +
                        ...
                        "- Wyrażam zgodę na przesyłanie mi informacji przez " + s1 + " za pomocą środków komunikacji elektronicznej...\n" +
                        "- Zgadzam się na przetwarzanie moich danych osobowych przez Administratora Danych, którym jest " +
        ...
        Paragraph p15 = new Paragraph(member.getEmail() != null
                ? "Email : " + member.getEmail()
                : "Email : Nie podano", font(11, 0));
        ...
        if (member.getAddress().getStreet() != null)
            p17.add("Ulica : " + member.getAddress().getStreet() + "\n");
