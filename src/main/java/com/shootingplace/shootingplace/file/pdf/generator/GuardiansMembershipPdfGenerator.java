...
public class GuardiansMembershipPdfGenerator {
    ...
    public PdfGenerationResults generate(MemberEntity member) throws DocumentException, IOException {
        ...
        // ========================= STRONA 1 =========================
        addHeaderWithLogo(document, normal, small);
...
//        skladki.setSpacingAfter(15);
//        document.add(skladki);
        ...
        Paragraph rodoZgoda = new Paragraph(
                "Wyrażam zgodę na gromadzenie oraz przetwarzanie moich danych osobowych, dobrowolnie " +
                        "zawartych w niniejszej deklaracji, do celów statutowych Klubu oraz do sporządzania stosownych " +
                        "sprawozdań dla podmiotów upoważnionych do nadzoru nad działalnością Klubu w zakresie " +
                        "strzelectwa sportowego (w tym dla Polskiego Związku Strzelectwa Sportowego, Wielkopolskiego " +
                        "Związku Strzelectwa Sportowego, Policji) zgodnie z ustawą z dnia 29 sierpnia 1997 roku o ochronie " +
                        "danych osobowych (Dz. U. Nr 133 poz. 833, z 2000 r. z późn. zm.). Wyrażam zgodę na udostępnianie " +
                        "danych (imię i nazwisko) w mediach społecznościowych na potrzeby Klubu (komunikaty z zawodów " +
                        "sportowych). Jednocześnie oświadczam, iż uznaję przesyłanie przez Klub korespondencji " +
                        "elektronicznej na podany przeze mnie adres elektroniczny za skuteczną formę doręczenia. ",
                normal
        );
        ...
        Phrase decyzjaPrzyjecieText = new Phrase("Decyzją Zarządu Stowarzyszenia Klub Strzelecki Guardians Nowolipsk\n" +
                (member.getSex() ? "Pani " : "Pan ") + member.getFullName() + (member.getSex() ? " została przyjęta" : " został przyjęty") +
                " w poczet Członków Stowarzyszenia\n" +
                "Uchwałą Zarządu nr .............................. z dnia ...........................................\n\n"
                , normal);
        Paragraph decyzjaPrzyjeciePodpis = new Paragraph(
                ".........................................................................................................................\n" +
                        "        (pieczęć i podpis Prezesa lub Wiceprezesa Stowarzyszenia)        \n", normal
        );
        ...
        Phrase decyzjaSkreslenieText = new Phrase(
                "Decyzją Zarządu Stowarzyszenia Klub Strzelecki Guardians Nowolipsk\n" +
                        (member.getSex() ? "Pani " : "Pan ") + member.getFullName() + (member.getSex() ? " została skreślona" : " został skreślony") +
    ...
    private void addHeaderWithLogo(Document document, Font normal, Font small) throws DocumentException, IOException {
        ...
        Phrase clubInfoText = new Phrase(
                "Nowolipsk 59, 63-613 Chocz\n" +
                        ...
                        "E-mail: biuro@ksguardians.pl   Nr kontaktowy: 501 591 659",
                font(10, 0)
        );
